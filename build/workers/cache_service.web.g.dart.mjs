...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _290: x0 => x0.cancel(),
      _291: x0 => ({type: x0}),
      _292: (x0,x1) => new Blob(x0,x1),
      _293: x0 => globalThis.URL.createObjectURL(x0),
      _296: (x0,x1,x2) => x0.postMessage(x1,x2),
      _297: x0 => x0.close(),
      _298: () => new MessageChannel(),
      _299: (x0,x1) => x0.push(x1),
      _310: () => globalThis.self,
      _311: x0 => x0.close(),
      ...
      _314: (x0,x1,x2) => x0.postMessage(x1,x2),
      _315: (x0,x1) => x0.postMessage(x1),
