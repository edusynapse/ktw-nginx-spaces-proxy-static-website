...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      A.bootstrap(A.cache_service__$CacheServiceInitializer$closure(), null);
    },
    isSameInstance(a, b) {
      var t1;
      A._asObject(a);
  ...
  A.CacheService.prototype = {
    downloadAndBase64$1(url) {
      return this.downloadAndBase64$body$CacheService(url);
    },
    downloadAndBase64$body$CacheService(url) {
      var $async$goto = 0,
      ...
      var $async$downloadAndBase64$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$handler = 4;
              $async$goto = 7;
              return A._asyncAwait(A.get(A.Uri_parse(url)), $async$downloadAndBase64$1);
            case 7:
              // returning from await.
              response = $async$result;
              if (response.statusCode === 200) {
                t1 = type$.Base64Codec._eval$1("Codec.S")._as(response.bodyBytes);
                t1 = B.C_Base64Codec.get$encoder().convert$1(t1);
                $async$returnValue = t1;
                // goto return
                $async$goto = 1;
                break;
    ...
    decodeBase64$1(b64) {
      var $async$goto = 0,
        ...
        $async$returnValue;
      var $async$decodeBase64$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$returnValue = B.C_Base64Decoder.convert$1(b64);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$decodeBase64$1, $async$completer);
    },
    createObjectUrl$1(bytes) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, buffer, t1, blob;
      var $async$createObjectUrl$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              buffer = type$.NativeArrayBuffer._as(B.NativeUint8List_methods.get$buffer(bytes));
              t1 = init.G;
              blob = A._asJSObject(new t1.Blob(A._setArrayType([buffer], type$.JSArray_NativeArrayBuffer), {type: "audio/wav"}));
              $async$returnValue = A._asString(t1.URL.createObjectURL(blob));
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$createObjectUrl$1, $async$completer);
    },
    encodeBase64$1(bytes) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue;
      var $async$encodeBase64$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              type$.Base64Codec._eval$1("Codec.S")._as(bytes);
              $async$returnValue = B.C_Base64Codec.get$encoder().convert$1(bytes);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$encodeBase64$1, $async$completer);
    }
  };
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $$dsr = A._$Deser$(false);
              $async$goto = 6;
              return A._asyncAwait($async$self._this.createObjectUrl$1($$dsr.$$0$1(J.$index$asx(type$.List_dynamic._as(J.$index$asx($$req, 3)), 0))), $async$call$1);
            case 6:
              // returning from await.
              $$res = $async$result;
              $async$next.push(5);
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $$dsr = A._$Deser$(false);
              $async$goto = 6;
              return A._asyncAwait($async$self._this.decodeBase64$1($$dsr.$$1$1(J.$index$asx(type$.List_dynamic._as(J.$index$asx($$req, 3)), 0))), $async$call$1);
            case 6:
              // returning from await.
              $$res = $async$result;
              $async$next.push(5);
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $$dsr = A._$Deser$(false);
              $async$goto = 6;
              return A._asyncAwait($async$self._this.downloadAndBase64$1($$dsr.$$1$1(J.$index$asx(type$.List_dynamic._as(J.$index$asx($$req, 3)), 0))), $async$call$1);
            case 6:
              // returning from await.
              $$res = $async$result;
              $async$next.push(5);
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $$dsr = A._$Deser$(false);
              $async$goto = 6;
              return A._asyncAwait($async$self._this.encodeBase64$1($$dsr.$$0$1(J.$index$asx(type$.List_dynamic._as(J.$index$asx($$req, 3)), 0))), $async$call$1);
            case 6:
              // returning from await.
              $$res = $async$result;
              $async$next.push(5);
  ...
  A._$CacheService$WorkerService.prototype = {$isWorkerService: 1};
  A._$Deser.prototype = {
    get$$$0() {
      var result, _this = this,
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "cache_service__$CacheServiceInitializer$closure", "$CacheServiceInitializer", 50);
    ...
    _instance(_, "get$error", 0, 1, null, ["call$3", "call$1", "call$2"], ["error$3", "error$1", "error$2"], 36, 0, 0);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A.Error, A.Closure, A.SentinelValue, A.Iterable, A.ListIterator, A.MappedIterator, A.WhereIterator, A.SkipIterator, A.EmptyIterator, A.FixedLengthListMixin, A.ConstantMap, A._KeysOrValuesOrElementsIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.LinkedHashMapEntryIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._Cell, A._UnmodifiableNativeByteBufferView, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A._AsyncStarStreamController, A._IterationMarker, A._SyncStarIterator, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._StreamController, A._AsyncStreamControllerDispatch, A._BufferingStreamSubscription, A._AddStreamState, A._DelayedEvent, A._DelayedDone, A._PendingEvents, A._DoneStreamSubscription, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.Codec, A.Converter, A._Base64Encoder, A._Base64Decoder, A.ByteConversionSink, A._JsonStringifier, A._JsonPrettyPrintMixin, A._BigIntImpl, A.DateTime, A.Duration, A._Enum, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.IntegerDivisionByZeroException, A.MapEntry, A.Null, A._StringStackTrace, A.StringBuffer, A._Uri, A.UriData, A._SimpleUri, A.NullRejectionException, A.CancelationToken, A.ClientException, A.BaseClient, A.BaseRequest, A.BaseResponse, A.CacheService, A.MarshalingContext, A.LogEvent, A.LogFilter, A.LogOutput, A.LogPrinter, A.Logger, A.OutputEvent, A._WebWorkerChannel, A.WorkerRunner, A.Converter0, A.SerializationContext, A.SquadronException, A.CancelationTokenReference]);
    ...
    _inheritMany(A.Converter, [A.Base64Encoder, A.Base64Decoder, A.JsonEncoder]);
    ...
    _inherit(A._$CacheService$WorkerService, A.CacheService);
...
//# sourceMappingURL=cache_service.web.g.dart.js.map
