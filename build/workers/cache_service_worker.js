...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _$CacheService$Invoker: function _$CacheService$Invoker() {
    },
    _$CacheService$Facade: function _$CacheService$Facade() {
    },
    CacheServiceWorker: function CacheServiceWorker(t0, t1) {
      this.Releasable__released = t0;
      this.Releasable__token = t1;
    },
    _CacheServiceWorker_Worker__$CacheService$Invoker: function _CacheServiceWorker_Worker__$CacheService$Invoker() {
    },
    _CacheServiceWorker_Worker__$CacheService$Invoker__$CacheService$Facade: function _CacheServiceWorker_Worker__$CacheService$Invoker__$CacheService$Facade() {
    },
    main() {
    ...
    SquadronException_from(error, stackTrace, command) {
      ...
      if (error instanceof A.WorkerException) {
        ...
        t2 = new A.WorkerException(command, t1, stackTrace);
        t2.SquadronException$init$2(t1, stackTrace);
        return t2;
      }
    },
    ...
    $getCacheServiceActivator(platform) {
      if (platform === B.SquadronPlatformType_JavaScript_js)
        return A.mapUrl("workers/cache_service.web.g.dart.js");
      else if (platform === B.SquadronPlatformType_Dqj)
        return A.mapUrl("workers/cache_service.web.g.dart.wasm");
      else
    ...
    WorkerRequestExt_unwrapInPlace(_this, logger) {
      var t1, ts, t2, _null = null;
      if (0 >= _this.length)
        return A.ioore(_this, 0);
      t1 = A._asNumQ(_this[0]);
      ts = t1 == null ? _null : B.JSNumber_methods.toInt$0(t1);
      if (ts != null)
        J.$indexSet$ax(_this, 0, A.microsecTimeStamp(_null) - ts);
      if (2 >= _this.length)
  ...
  A._$CacheService$Invoker.prototype = {};
  A._$CacheService$Facade.prototype = {};
  A.CacheServiceWorker.prototype = {};
  A._CacheServiceWorker_Worker__$CacheService$Invoker.prototype = {};
  A._CacheServiceWorker_Worker__$CacheService$Invoker__$CacheService$Facade.prototype = {};
  A.main_closure.prototype = {
    call$1(startRequest) {
      A.$getCacheServiceActivator($.$get$Squadron_platformType());
      return new A.CacheServiceWorker(false, new A.Object());
    },
    $signature: 19
  };
  ...
  A.$jsify_closure1.prototype = {
    call$1(obj) {
      var t1, cached, jsifier, len, jsArray, i, kjsifier, vjsifier, jsMap, t2, jsSet, value, res, _this = this;
      if (obj == null)
        return null;
      t1 = _this.cache;
      ...
      if (type$.List_dynamic._is(obj) && !type$.TypedData._is(obj)) {
        ...
        for (i = 0; i < len; ++i) {
          ...
          A._asInt(jsArray.push(jsifier.call$1(obj[i])));
        }
        return jsArray;
      }
  ...
  A.WorkerRunner.prototype = {
    ...
    connect$body$WorkerRunner(startRequest, channelInfo, initializer) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, logger, ex, st, channel, t2, t3, exception, t1, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              if (1 >= startRequest.length) {
                $async$returnValue = A.ioore(startRequest, 1);
                // goto return
                $async$goto = 1;
                break;
              }
              channel = type$.nullable_WorkerChannel._as(startRequest[1]);
              t1.channel = channel;
              if (channel == null) {
              ...
              if (2 >= startRequest.length) {
                $async$returnValue = A.ioore(startRequest, 2);
                // goto return
                $async$goto = 1;
                break;
              }
              if (A._asInt(startRequest[2]) !== -1) {
            ...
            case 7:
              ...
              t2.toString;
              $async$self._operations = $.$get$WorkerService_noOperations();
    ...
    processRequest$body$WorkerRunner(request) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$next = [], $async$self = this, pendingInstallation, token, canceler, token0, tokenRef, cmd, op, result, reply, ex, st, t1, t2, t3, ex0, exception, channel, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = request.length;
              if (1 >= t1) {
                $async$returnValue = A.ioore(request, 1);
                // goto return
                $async$goto = 1;
                break;
              }
              t2 = type$.nullable_WorkerChannel;
              channel = t2._as(request[1]);
              if (2 >= t1) {
                $async$returnValue = A.ioore(request, 2);
                // goto return
                $async$goto = 1;
                break;
              }
              if (A._asInt(request[2]) === -4) {
              ...
              pendingInstallation = t1 == null ? null : t1.future;
            ...
            case 8:
              ...
              t3 = A._asInt(request[2]);
              if (t3 === -3) {
                if (4 >= t1) {
                  $async$returnValue = A.ioore(request, 4);
                  // goto return
                  $async$goto = 1;
                  break;
                }
                t1 = type$.nullable_SquadronCancelationToken._as(request[4]);
                t1.toString;
                token = t1;
                ...
                if (5 >= t1) {
                  $async$returnValue = A.ioore(request, 5);
                  // goto return
                  $async$goto = 1;
                  break;
                }
                canceler = $async$self._streamCancelers.$index(0, A._asIntQ(request[5]));
                t1 = canceler;
              ...
              t1 = type$.nullable_SquadronCancelationToken;
              token0 = t1._as(request[4]);
              t3 = token0;
              if (t3 != null)
                t3.throwIfCanceled$0();
              ...
              token = $async$self._getTokenRef$1(t1._as(request[4]));
              if (token._hasRef) {
                ++token._refCount;
                if (4 >= request.length) {
                  $async$returnValue = A.ioore(request, 4);
            ...
            case 14:
              // join
              if (6 >= request.length) {
                $async$returnValue = A.ioore(request, 6);
                $async$next = [1];
                // goto finally
                $async$goto = 11;
                break;
              }
              if (A._asBool(request[6])) {
                t1 = t2._as(request[1]);
  ...
  A.Worker.prototype = {$isWorkerService: 1};
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(_, "get$log", "log$1", 35);
    _static_1(A, "squadron_canceled_exception__SquadronCanceledExceptionExt_deserialize$closure", "SquadronCanceledExceptionExt_deserialize", 34);
    _static_2(A, "_platform__isSameInstance$closure", "isSameInstance", 23);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A.Error, A.SentinelValue, A.Iterable, A.ListIterator, A.MappedIterator, A.WhereIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.LinkedHashMapEntryIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._Cell, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.Codec, A.Converter, A._JsonStringifier, A._JsonPrettyPrintMixin, A._BigIntImpl, A.DateTime, A.Duration, A._Enum, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.IntegerDivisionByZeroException, A.MapEntry, A.Null, A._StringStackTrace, A.StringBuffer, A._Uri, A.UriData, A._SimpleUri, A.NullRejectionException, A.CancelationToken, A._$CacheService$Invoker, A._$CacheService$Facade, A._Worker_Object_Releasable, A.LogEvent, A.LogFilter, A.LogOutput, A.LogPrinter, A.Logger, A.OutputEvent, A._WebWorkerChannel, A.WorkerRunner, A.SquadronException, A.CancelationTokenReference, A.Releasable]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A.Future_wait_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A._CustomHashMap_closure, A.MapBase_entries_closure, A._BigIntImpl_hashCode_finish, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.dartify_convert, A.main_closure, A.bootstrap_closure0, A.bootstrap_closure, A.$jsify_closure, A.$jsify_closure0, A.$jsify_closure1, A.$dartify_closure, A.JsWorkerRunnerExt_get_handle_closure, A.WorkerRunner__checkOperations_closure, A.WorkerRunner_connect_closure, A.SquadronCanceledException_SquadronCanceledException$from_closure, A.SquadronCanceledExceptions_message_closure, A.SquadronCanceledExceptions_serialize_closure]);
    ...
    _inherit(A._CacheServiceWorker_Worker__$CacheService$Invoker, A.Worker);
    _inherit(A._CacheServiceWorker_Worker__$CacheService$Invoker__$CacheService$Facade, A._CacheServiceWorker_Worker__$CacheService$Invoker);
    _inherit(A.CacheServiceWorker, A._CacheServiceWorker_Worker__$CacheService$Invoker__$CacheService$Facade);
    ...
    _mixin(A._CacheServiceWorker_Worker__$CacheService$Invoker, A._$CacheService$Invoker);
    _mixin(A._CacheServiceWorker_Worker__$CacheService$Invoker__$CacheService$Facade, A._$CacheService$Facade);
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "WorkerService_noOperations", "$get$WorkerService_noOperations", () => A.LinkedHashMap_LinkedHashMap$_empty(type$.int, A.findType("@(List<@>)")));
  })();
...
//# sourceMappingURL=cache_service_worker.js.map
