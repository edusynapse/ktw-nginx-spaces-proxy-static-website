...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1468: (x0,x1) => x0.debug(x1),
      _1469: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1469(f,arguments.length,x0,x1) }),
      _1470: x0 => new ResizeObserver(x0),
      _1471: (x0,x1) => x0.observe(x1),
      _1472: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1472(f,arguments.length,x0,x1) }),
      _1473: x0 => new MutationObserver(x0),
      _1474: x0 => ({childList: x0}),
      _1475: (x0,x1,x2) => x0.observe(x1,x2),
      _1476: (x0,x1) => x0.item(x1),
      _1477: (x0,x1) => x0.getElementById(x1),
      ...
      _1997: x0 => new Worker(x0),
      _2001: x0 => x0.terminate(),
      _2003: x0 => x0.close(),
      _2004: () => new MessageChannel(),
      _2010: () => new XMLHttpRequest(),
      _2011: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _2012: x0 => x0.send(),
      _2016: (x0,x1,x2) => x0.postMessage(x1,x2),
      _2017: (x0,x1) => x0.push(x1),
      ...
      _2024: (x0,x1,x2) => x0.postMessage(x1,x2),
      _2026: (x0,x1) => globalThis.Object.is(x0,x1),
      _2027: (x0,x1) => x0.at(x1),
      _2028: x0 => x0.entries(),
      _2029: x0 => x0.values(),
      _2030: x0 => globalThis.BigInt(x0),
      _2031: () => new Map(),
      _2032: (x0,x1,x2) => x0.set(x1,x2),
      _2033: () => new Set(),
      _2034: (x0,x1) => x0.add(x1),
      _2035: x0 => x0.toString(),
      _2036: x0 => x0.length,
      _2038: x0 => x0.buffer,
      ...
      _2068: (x0,x1) => globalThis.fetch(x0,x1),
      ...
      _2198: (d, precision) => d.toPrecision(precision),
