...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1281: x0 => x0.reload(),
      _1282: (x0,x1) => x0.getElementById(x1),
      ...
      _1853: (x0,x1) => x0.replace(x1),
      _1854: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1854(f,arguments.length,x0) }),
      _1855: () => globalThis.Intl.DateTimeFormat(),
      _1856: x0 => x0.resolvedOptions(),
      _1857: () => globalThis.Intl.supportedValuesOf,
      _1859: x0 => x0.timeZone,
      _1860: (x0,x1) => x0.key(x1),
      _1869: Date.now,
      _1870: secondsSinceEpoch => {
      ...
      _1871: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1872: s => {
      ...
      _1874: () => typeof dartUseDateNowForTicks !== "undefined",
      _1875: () => 1000 * performance.now(),
      _1876: () => Date.now(),
      _1877: () => {
      ...
      _1879: () => new WeakMap(),
      _1880: (map, o) => map.get(o),
      _1881: (map, o, v) => map.set(o, v),
      _1882: x0 => new WeakRef(x0),
      _1883: x0 => x0.deref(),
      _1890: () => globalThis.WeakRef,
      _1893: s => JSON.stringify(s),
      _1894: s => printToConsole(s),
      _1895: (o, p, r) => o.replaceAll(p, () => r),
      _1896: (o, p, r) => o.replace(p, () => r),
      _1897: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1898: s => s.toUpperCase(),
      _1899: s => s.trim(),
      _1900: s => s.trimLeft(),
      _1901: s => s.trimRight(),
      _1902: (string, times) => string.repeat(times),
      _1903: Function.prototype.call.bind(String.prototype.indexOf),
      _1904: (s, p, i) => s.lastIndexOf(p, i),
      _1905: (string, token) => string.split(token),
      _1906: Object.is,
      _1907: o => o instanceof Array,
      _1908: (a, i) => a.push(i),
      _1909: (a, i) => a.splice(i, 1)[0],
      _1911: (a, l) => a.length = l,
      _1912: a => a.pop(),
      _1913: (a, i) => a.splice(i, 1),
      _1914: (a, s) => a.join(s),
      _1915: (a, s, e) => a.slice(s, e),
      _1916: (a, s, e) => a.splice(s, e),
      _1917: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1918: a => a.length,
      _1919: (a, l) => a.length = l,
      _1920: (a, i) => a[i],
      _1921: (a, i, v) => a[i] = v,
      _1922: (a, t) => a.concat(t),
      _1923: o => {
      ...
      _1926: o => o instanceof Uint8Array,
      _1927: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1928: o => o instanceof Int8Array,
      _1929: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1930: o => o instanceof Uint8ClampedArray,
      _1931: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1932: o => o instanceof Uint16Array,
      _1933: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1934: o => o instanceof Int16Array,
      _1935: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1936: o => o instanceof Uint32Array,
      _1937: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1938: o => o instanceof Int32Array,
      _1939: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1941: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1942: o => o instanceof Float32Array,
      _1943: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1944: o => o instanceof Float64Array,
      _1945: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1946: (t, s) => t.set(s),
      _1947: l => new DataView(new ArrayBuffer(l)),
      _1948: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1949: o => o.byteLength,
      _1950: o => o.buffer,
      ...
      _1976: () => globalThis.performance,
      _1977: () => globalThis.JSON,
      _1978: x0 => x0.measure,
      _1979: x0 => x0.mark,
      _1980: x0 => x0.clearMeasures,
      _1981: x0 => x0.clearMarks,
      _1982: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
      _1983: (x0,x1,x2) => x0.mark(x1,x2),
      _1984: x0 => x0.clearMeasures(),
      _1985: x0 => x0.clearMarks(),
      _1986: (x0,x1) => x0.parse(x1),
      _1987: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1988: (handle) => clearTimeout(handle),
      _1989: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1990: (handle) => clearInterval(handle),
      _1991: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1992: () => Date.now(),
      _1997: o => Object.keys(o),
      _1998: x0 => new Worker(x0),
      _2002: x0 => x0.terminate(),
      _2004: x0 => x0.close(),
      _2005: () => new MessageChannel(),
      ...
      _2666: (x0,x1) => { x0.as = x1 },
      _2802: (x0,x1) => { x0.target = x1 },
      _2804: (x0,x1) => { x0.download = x1 },
      _2808: (x0,x1) => { x0.rel = x1 },
      ...
      _11338: (x0,x1) => { x0.backgroundImage = x1 },
      _11342: (x0,x1) => { x0.backgroundPosition = x1 },
      _11352: (x0,x1) => { x0.backgroundRepeat = x1 },
      _11354: (x0,x1) => { x0.backgroundSize = x1 },
      _11382: (x0,x1) => { x0.border = x1 },
      _11660: (x0,x1) => { x0.display = x1 },
      _11824: (x0,x1) => { x0.height = x1 },
      _11880: (x0,x1) => { x0.left = x1 },
      _12036: (x0,x1) => { x0.opacity = x1 },
      _12148: (x0,x1) => { x0.pointerEvents = x1 },
      _12150: (x0,x1) => { x0.position = x1 },
      _12442: (x0,x1) => { x0.top = x1 },
      _12453: x0 => x0.transition,
      _12514: (x0,x1) => { x0.width = x1 },
      _12542: (x0,x1) => { x0.zIndex = x1 },
      _12882: x0 => x0.name,
