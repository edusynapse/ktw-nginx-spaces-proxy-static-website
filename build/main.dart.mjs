...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1884: x0 => x0.options,
      _1898: x0 => ({scale: x0}),
      _1899: x0 => x0.deviceMemory,
      _1902: x0 => ({type: x0}),
      _1903: (x0,x1) => new Blob(x0,x1),
      _1904: () => new FileReader(),
      _1906: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1907: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1907(f,arguments.length,x0) }),
      _1908: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      ...
      _13682: () => globalThis.navigator,
      _13683: x0 => x0.deviceMemory,
      _13684: x0 => x0.hardwareConcurrency,
