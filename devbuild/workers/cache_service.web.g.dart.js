...
(function dartProgram() {
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "cache_service__$CacheServiceInitializer$closure", "$CacheServiceInitializer", 51);
    ...
    _instance(_, "get$error", 0, 1, null, ["call$3", "call$1", "call$2"], ["error$3", "error$1", "error$2"], 37, 0, 0);
    ...
    _static_2(A, "_platform__isSameInstance$closure", "isSameInstance", 36);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Object?(Object?)", "~(@)", "Null(@)", "Null()", "~(Object,StackTrace)", "~(Object?,Object?)", "~(Object?)", "Future<String>(List<@>)", "String()", "~(~())", "int(Object?)", "@(@)", "~(Object[StackTrace?])", "Null(Object,StackTrace)", "bool(Object?)", "Future<~>()", "int(int,int)", "Null(Object)", "bool()", "bool(Object?,Object?)", "Null(@,StackTrace)", "~(String,int?)", "@(String)", "Future<Response>(Client)", "bool(String,String)", "int(String)", "Null(String,String[Object?])", "bool(Object)", "~(List<int>)", "~(int,@)", "Future<Uint8List>(List<@>)", "Future<~>(List<@>)", "~(WorkerRunner)", "Null(JSObject)", "~(@,StackTrace)", "bool(Object,Object)", "~(Object[StackTrace?,int?])", "_Future<@>?()", "~(JSObject)", "bool(int)", "~(OutputEvent)", "CancelationTokenReference()", "@(@,String)", "Null(@,@)", "SquadronCanceledException(CanceledException)", "String(SquadronCanceledException)", "List<@>(SquadronCanceledException)", "Null(~())", "int(int)", "~(String,int)", "WorkerService(List<@>)", "0^(@)<Object?>", "SquadronCanceledException?(List<@>?)", "~(LogEvent)"],
